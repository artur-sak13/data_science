...
# The Data Life Cycle helps in explaining how different objectives of data management (whether that be research, preservation, or delivery)
# are all interconnected. One of the biggest issues facing researchers today is that digital data is often not structured properly or lacks
# essential metadata that can help in making judgements about relevancy. In order to make the most of digital data it is necessary to understand 
# that the life of digital data does not end when the 'research period' is over, but rather persists until the data no longer becomes relevant
# and is destoyed. Therefore, properly managing data according to it's life cycle opens up opportunities for reuse in future studies and
# potentially mitigating some of the costs (both monitary and opportunity) associated with accessing and working with such data.
